...
Hemos entrenado un bosque aleatorio para predecir el valor que nos interesa, logrando una precisión del 89.5% y un F1 de 0.894. Estos resultados indican que el modelo es confiable y equilibra bien las clases.

Las características más importantes del modelo, como el área y el perímetro más grandes del tumor (worst area y worst perimeter), son las que más influyen en su predicción. Esto es útil porque indica que la magnitud y la forma de la región más extensa del tumor son clave para determinar su comportamiento.
