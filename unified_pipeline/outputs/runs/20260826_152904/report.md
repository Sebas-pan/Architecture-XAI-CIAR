...
Usamos un bosque aleatorio para predecir el valor que nos interesa y consiguió una precisión del 89.5%, lo que indica que acertó la mayoría de las predicciones. Su puntuación F1 de 0.894 muestra que el modelo es muy efectivo.

Las características más influyentes son el área, el perímetro y los puntos cóncavos más grandes, seguidos del radio promedio y la concavidad media. Estas variables reflejan el tamaño y la forma de la lesión, ayudando al modelo a predecir su naturaleza con mayor exactitud.
