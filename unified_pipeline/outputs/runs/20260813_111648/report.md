# Reporte — Detección YOLO11 (Cats/Dogs)

## Entrenamiento
- Modelo: `yolo11` (variante `yolov11n`)
- Dispositivo: `0` · tiempo: 2.16 min
- Clases: Cat, Dog
- EDA: `eda_image.png` y `eda_image.json` (distribución por split, stats de tamaño)
...
### GRADCAM
**ERROR**: Setting requires_grad=True on inference tensor outside InferenceMode is not allowed.
